...
namespace Demo
{
    ...
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            await RunDemo("Workflow Compile", WorkflowCompileDemo);
        ...
        // ─── 12. Workflow Compile ───
        private static Task WorkflowCompileDemo()
        {
            var wf = new Workflow
            {
            ...
            var adult = _customers.First(c => c.Age >= 18 && c.IsActive && c.Orders.Count > 0);
            var minor = _customers.First(c => c.Age < 18);
